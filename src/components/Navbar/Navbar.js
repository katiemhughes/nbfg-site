        ...
        <div className="wrapper">
          <div className="top-nav">
            ...
            <div className="right">
              ...
              <ul>
                <li><a href="https://www.instagram.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-instagram"></i></a></li>
                <li><a href="https://www.facebook.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-facebook"></i></a></li>
                <li><a href="https://www.twitter.com/nbfgmcr" target="_blank" rel="noreferrer" className="icon__twitter">
                ...
                <li><a href="https://www.tiktok.com/@notbadforagirlmcr" target="_blank" rel="noreferrer" className="icon__tiktok">
                ...
                <li><a href="https://www.soundcloud.com/notbadforagirlmcr" target="_blank" rel="noreferrer" className="icon__soundcloud">
