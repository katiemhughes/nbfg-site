        ...
        <div className="navbar">
          <div className="navbar__top">
            ...
            <div className="navbar__right">
              ...
              <ul className="logos">
                <li className="logos__logo"><a href="https://www.instagram.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-instagram"></i></a></li>
                <li className="logos__logo"><a href="https://www.facebook.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-facebook"></i></a></li>
