              ...
              <ul className={click ? "links--active" : "links"}>
                <li className="links__link">
                  ...
                  <div className="logos__mobile">
                    ...
                    <li className={click ? "logo__mobile--active" : "logo__mobile"}><a href="https://www.facebook.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-facebook"></i></a></li>
                    <li className={click ? "logo__mobile--active" : "logo__mobile"}><a href="https://www.twitter.com/nbfgmcr" target="_blank" rel="noreferrer" className="logo__icon">
                    ...
                    <li className={click ? "logo__mobile--active" : "logo__mobile"}><a href="https://www.tiktok.com/@notbadforagirlmcr" target="_blank" rel="noreferrer" className="logo__icon">
                    ...
                    <li className={click ? "logo__mobile--active" : "logo__mobile"}><a href="https://www.soundcloud.com/notbadforagirlmcr" target="_blank" rel="noreferrer" className="logo__icon">
