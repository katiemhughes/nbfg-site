...
const Contact = () => {
    ...
    const { contactTitle, contactEmail, financeEmail, instagramLink, facebookLink, twitterLink, twitterAlt, tiktokLink, tiktokAlt, soundcloudLink, soundcloudAlt, portfolioLinkText, portfolioLinkName, portfolioLink } = contact;
            ...
            <ul className="logos">
                <li className="logos__logo">
                  <a href={instagramLink} target="_blank" rel="noreferrer">
                    <i className="fab fa-instagram logo__icon"></i>
                  </a>
                </li>
                <li className="logos__logo">
                  <a href={facebookLink} target="_blank" rel="noreferrer">
                    <i className="fab fa-facebook logo__icon"></i>
                  </a>
                </li>
                <li className="logos__logo">
              ...
              <p className='details__signature'>{portfolioLinkText} <a className='details__portfolio' href={portfolioLink} target="_blank" rel="noreferrer">{portfolioLinkName}</a></p>
        </div>
    </footer>
  )
}
