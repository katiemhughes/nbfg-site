        ...
        <div className='contact__information'>
            <div className='text-content'>
                ...
                <div className='text-content__container'>
                    ...
                    <a href='mailto:notbadforagirlmcr@gmail.com' className='enquiries__email'>{contactEmail}</a>
                </div>
                <div className='text-content__container'>
                    <p className='enquiries__text'>Finance enquiries:</p>
                    <a href='mailto:financenbfg@gmail.com' className='enquiries__email'>{financeEmail}</a>
                </div>
            </div>
            <ul className="logos">
                <li className="logos__logo"><a href="https://www.instagram.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-instagram logo__icon"></i></a></li>
                <li className="logos__logo"><a href="https://www.facebook.com/notbadforagirlmcr" target="_blank" rel="noreferrer"><i className="fab fa-facebook logo__icon"></i></a></li>
                <li className="logos__logo"><a href="https://www.twitter.com/nbfgmcr" target="_blank" rel="noreferrer" className="logo__icon">
                ...
                <li className="logos__logo"><a href="https://www.tiktok.com/@notbadforagirlmcr" target="_blank" rel="noreferrer" className="logo__icon">
                ...
                <li className="logos__logo"><a href="https://www.soundcloud.com/notbadforagirlmcr" target="_blank" rel="noreferrer" className="logo__icon">
